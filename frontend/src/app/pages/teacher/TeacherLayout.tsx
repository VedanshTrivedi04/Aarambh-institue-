        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-slate-100 text-slate-600 border border-slate-200 inline-block">
                Teacher Panel
              </div>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 bg-white">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-red-100 text-red-700 inline-block">
                {user?.email || "Teacher"}
              </div>
            </div>
          </div>
